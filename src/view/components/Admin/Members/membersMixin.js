    ...
    methods: {
        downloadExcel() {
            ...
            const _h = [
                ...
                {label: 'بسیج - سمت', value: 'executiveHistory_post_basij'},
                {label: 'بسیج - سابقه اجرایی', value: 'executiveHistory_history_basij'},
                {label: 'بسیج - توضیحات', value: 'executiveHistory_description_basij'},

                {label: 'سابقه اجرایی در انجمن اسلامی', value: 'executiveHistory_has_anjoman'},
                {label: 'انجمن اسلامی - سمت', value: 'executiveHistory_post_anjoman'},
                {label: 'انجمن اسلامی - سابقه اجرایی', value: 'executiveHistory_history_anjoman'},
                ...
                {label: 'هیأت مذهبی - سمت', value: 'executiveHistory_post_heyat'},
                {label: 'هیأت مذهبی - سابقه اجرایی', value: 'executiveHistory_history_heyat'},
                ...
                {label: 'هلال احمر - سمت', value: 'executiveHistory_post_helal'},
                {label: 'هلال احمر - سابقه اجرایی', value: 'executiveHistory_history_helal'},
                {label: 'هلال احمر - توضیحات', value: 'executiveHistory_description_helal'},

                {label: 'سابقه اجرایی در سازمان دانش‌آموزی', value: 'executiveHistory_has_sazmanedaneshamoozi'},
                {label: 'سازمان دانش‌آموزی - سمت', value: 'executiveHistory_post_sazmanedaneshamoozi'},
                {label: 'سازمان دانش‌آموزی - سابقه اجرایی', value: 'executiveHistory_history_sazmanedaneshamoozi'},
                {label: 'سازمان دانش‌آموزی - توضیحات', value: 'executiveHistory_description_sazmanedaneshamoozi'},

                {label: 'سابقه اجرایی در خبرگزاری پانا', value: 'executiveHistory_has_pana'},
                {label: 'خبرگزاری پانا - سمت', value: 'executiveHistory_post_pana'},
                {label: 'خبرگزاری پانا - سابقه اجرایی', value: 'executiveHistory_history_pana'},
                ...
                {label: 'سایر موارد - سمت', value: 'executiveHistory_post_other'},
                {label: 'سایر موارد - سابقه اجرایی', value: 'executiveHistory_history_other'},
                {label: 'سایر موارد - توضیحات', value: 'executiveHistory_description_other'},


                {label: 'شرکت در دوره طرح ولایت', value: 'executiveHistory.breedingAssistantName'},
                {label: 'طرح ولایت استانی / حوزه‌ای', value: 'executiveHistory.breedingAssistantName'},
                {label: 'طرح ولایت استانی / حوزه‌ای', value: 'executiveHistory.breedingAssistantName'},

                {label: 'شرکت در دوره آستان قدس', value: 'executiveHistory.breedingAssistantName'},
                {label: 'آستان قدس - بی‌نهایت شو', value: 'executiveHistory.breedingAssistantName'},
                ...
                {label: 'اوقاف - ترتیل', value: 'executiveHistory.breedingAssistantName'},
                {label: 'اوقاف - قرائت', value: 'executiveHistory.breedingAssistantName'},
                {label: 'اوقاف - حفظ', value: 'executiveHistory.breedingAssistantName'},
            ]
            ...
            for (let i = 0; i < quraniKeys.length; i++) {
                ...
                _h.push({
                    label: baseTitle + quraniItem.title + ' - ' + 'عنوان رشته',
                    value: baseKey + 'title',
                })
                _h.push({
                    label: baseTitle + quraniItem.title + ' - ' + 'رتبه استانی یا کشوری',
                    value: baseKey + 'rank',
                })
                _h.push({
                    label: baseTitle + quraniItem.title + ' - ' + 'سطح',
                    value: baseKey + 'level',
                })
            }
            this.getVarzeshiKeys().map(varzeshiItem => {
                ...
                _h.push({
                    label: baseTitle + varzeshiItem.title + ' - ' + 'عنوان رشته',
                    value: baseKey + 'title',
                })
                _h.push({
                    label: baseTitle + varzeshiItem.title + ' - ' + 'رتبه استانی یا کشوری',
                    value: baseKey + 'rank',
                })
                _h.push({
                    label: baseTitle + varzeshiItem.title + ' - ' + 'سطح',
                    value: baseKey + 'level',
                })
            })
            ...
            this.getHonariKeys().map(honariItem => {
                ...
                _h.push({
                    label: baseTitle + honariItem.title + ' - ' + 'عنوان رشته',
                    value: baseKey + 'title',
                })
                _h.push({
                    label: baseTitle + honariItem.title + ' - ' + 'رتبه استانی یا کشوری',
                    value: baseKey + 'rank',
                })
                _h.push({
                    label: baseTitle + honariItem.title + ' - ' + 'سطح',
                    value: baseKey + 'level',
                })
            })
        ...
        getExecutiveKeys() {
            return [
                ...
                {
                    title: "سازمان دانش‌آموزی",
                    key: "sazmanedaneshamoozi"
                },
                {
                    title: "خبرگزاری پانا",
                    key: "pana"
