  ...
  methods: {
    ...
    downloadExcel() {
      ...
      const _h = [
        ...
        {label: 'نوع مسکن', value: 'housingType'},
        {label: 'مقدار اولیه نقدی', value: 'initialCashAmount'},
        {label: 'درآمد ماهیانه', value: 'monthlyIncome'},
        {label: 'میزان اقساط ماهیانه', value: 'monthlyInstallmentsAmount'},
        {label: 'پروژه', value: 'projectTitle'},
        {label: 'متراژ موردانتظار', value: 'suggestedUsableArea'},
        {label: 'شماره شناسنامه', value: 'birthCertificateNumber'},
      ...
      let settings = {
        fileName: `Petus_DataExport_customers_${this.faToEn(this.getPersianTime(new Date(), 'YYYY_MM_DD_HH_mm_ss'))}`,
        writeMode: "writeFile",
        RTL: true,
        writeOptions: {},
      }
